...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=-4.5cm] at (current page marginpar area.north east){\includegraphics[width=8cm]{../data/images/OregonBeeAtlas-Logo-Final-03.png}};
