...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=-3cm] at (current page marginpar area.north east){\includegraphics[width=4cm]{../data/images/OBP_OregonBeeAtlas_Logo_black.jpg}};
...
ggplot() + geom_stars(data=st_rgb(b))+
  ...
  geom_text_repel(data = filter(st_transform(plantLocs,st_crs(b)),quality.x=='super',taxonLevel=='Genus'),
    aes(label = common_name, geometry = geometry),
    stat = "sf_coordinates",col='cyan',size=10)+
