...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=-3cm] at (current page marginpar area.north east){\includegraphics[width=7cm]{../data/images/OBP_OregonBeeAtlas_Logo_black.jpg}};
