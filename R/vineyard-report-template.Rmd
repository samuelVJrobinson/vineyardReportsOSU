...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=-3cm] at (current page marginpar area.north east){\includegraphics[height=1.8cm]{../data/images/OBP_OregonBeeAtlas_Logo_black.jpg}};
...
A *super bee plant* attracts a wide diversity of bees, rare specialist bees, and is also not a noxious weed. `r if(nrow(superPl_gen)>0) paste0('Some included plant genera have both native and non-native species. ')` `r if(any(superPl_gen$isWeedy|!superPl_gen$isNative)|any(superPl_spp$isWeedy|!superPl_spp$isNative)) paste0('Minor weeds and exotic plants _are_ included in this list, because they are contributing to your bee diversity. We recommend that future flower plantings be done using native species. ')` 
