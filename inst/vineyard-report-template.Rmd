...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=north west,rectangle,,yshift=-0.5cm,xshift=0.5cm] at (current page.north west){\includegraphics[height=2.3cm]{../inst/extdata/OSU_ES-MM_horizontal_1C_W.png}};
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=-4.5cm] at (current page marginpar area.north east){\includegraphics[width=8cm]{../inst/extdata/OregonBeeAtlas-Logo-Final-03.png}};
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=0cm] at (current page marginpar area.north east){\includegraphics[height=2.3cm]{../inst/extdata/OregonFlora logo.jpg}};
...
\includegraphics[width=2.5cm]{../inst/extdata/purple-fireweed-hi.png}
