...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0cm,xshift=0cm] at (current page marginpar area.north east){\includegraphics[height=2.3cm]{../inst/extdata/OregonFlora_logo.jpg}};
