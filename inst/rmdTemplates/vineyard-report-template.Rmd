...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east,rectangle,,yshift=0.2cm,xshift=-4.5cm] at (current page marginpar area.north east){\includegraphics[width=4.5cm]{../extdata/Oregon-BeeAtlas-Logo.png}};
